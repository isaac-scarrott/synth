...
struct PersistedBranch: Codable {
    ...
    /// When the row was archived — the clock the clean-up measures against, and the one piece
    /// of archive state that must survive a quit. Optional/omitted so pre-archive snapshots
