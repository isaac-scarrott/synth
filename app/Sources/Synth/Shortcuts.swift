...
struct ShortcutsSheet: View {
    ...
    fileprivate static let categories: [ShortcutCategory] = [
        ...
        ShortcutCategory(name: "Split layout", icon: Phosphor.squares, rows: [
            ...
            Shortcut(keys: ["⌘", "⇧", "—"], label: "Split stacked"),
            Shortcut(keys: ["⌘", "⌥", "→"], label: "Focus pane", alt: ["⌘", "⌥", "L"]),
            Shortcut(keys: ["⌘", "1"], label: "Focus pane N", alt: ["⌘", "9"]),
            Shortcut(keys: ["⌘", "0"], label: "Focus sidebar"),
            Shortcut(keys: ["⌘", "`"], label: "Cycle panes", alt: ["⌘", "⇧", "`"]),
            Shortcut(keys: ["⌘", "⌥", "⇧", "→"], label: "Resize pane"),
            Shortcut(keys: ["⌘", "⇧", "⏎"], label: "Zoom pane"),
            Shortcut(keys: ["⌘", "⇧", "U"], label: "Unsplit"),
        ]),
