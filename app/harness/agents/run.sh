...
P=0; F=0
for t in t1_template t2_resume t3_notifs t4a_mcpconfig t4b_agent_browser t5_comment t6_abort t7_regression t8_appmcp t9_archive t10_toasts t11_update t12_scratch; do
